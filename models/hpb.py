...
class Fusion(nn.Module):
    ...
    def forward(self, x1,x2):
        ...
        # print(x2.shape)
        if(w1!=w2):
            x2 =F.pad(x2, (0, 1, 1, 0), "constant", 0)
        # print(x2.shape)
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        if (w1 != w2):
            out = F.pad(out, (0, 1, 0, 0), "constant", 0)
...
class UN(nn.Module):
    def __init__(self, n_feats, wave):
        ...
        self.encoder1 = HPB(n_feats, wave)
        self.encoder2 = HPB(n_feats, wave)
        self.encoder3 = HPB(n_feats, wave)
