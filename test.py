...
parser.add_argument("--dataset_dir", type=str, default='/Test',
...
def main():
    ...
    # for key, nkey in zip(args.model_arch.keys(), args.pretrained_model.keys()):
    #     if key != nkey:
    #         # remove the 'module.' in the 'key'
    #         args.model_arch[key[7:]] = deepcopy(args.pretrained_model[key])
    #     else:
    #         args.model_arch[key] = deepcopy(args.pretrained_model[key])
